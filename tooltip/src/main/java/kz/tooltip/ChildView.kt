    ...
    fun attach() {
        ...
        if (iconStart.drawable != null) {
            ...
            if (startIconLayoutParams is LayoutParams) {
                startIconLayoutParams.marginEnd = context.resources.getDimensionPixelSize(R.dimen.iconTextMargin)
        ...
        if (iconEnd.drawable != null) {
            ...
            if (endIconLayoutParams is LayoutParams) {
                endIconLayoutParams.marginStart = context.resources.getDimensionPixelSize(R.dimen.iconTextMargin)
